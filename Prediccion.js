...
var modelo = null
 ...
 const canvas2 = document.querySelector("#pizarra2");
 ...
 function predecir() 
 {
       ...
       resample_single(canvas, 28, 28, pizarra2);

       var imgData = contexto2.getImageData(0,0,28,28);
       ...
       var tensor2 = tf.tensor4d(arr);
       var resultados = modelo.predict(tensor2).dataSync();
...
(async () => {
    ...
    modelo = await tf.loadLayersModel("./Modelo_AI/model (1).json");
...
//https://saludelectronica.com/machine-learning-en-la-web-con-angular-y-tensorflow/
